...
-(void)minimalDisplayOnView
{
    ...
    {
        _daysRemainingLabel.text = stringForSingleDays;
    }
    else
    {
        _daysRemainingLabel.text = [NSString stringWithFormat:@"%i days left",[self getDaysRemaining]];
    }
